...
const messages: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'contact.pasteImageHint': '可直接在问题框粘贴截图，最多 3 张；图片会在必要时自动压缩。',
    'contact.pastedImages': '已粘贴图片',
    'contact.removeImage': '移除图片',
    'contact.imageCountError': '最多只能粘贴 3 张图片',
    'contact.imageTotalError': '图片总大小不能超过 2MB',
    ...
    'fileManager.fileTooLarge': '{name} 超过 50 MB，未加入上传',
    ...
    'fileManager.dropzoneHint': '支持任意文件类型，单个文件不超过 50 MB；文件按顺序上传，避免占用过多内存。',
    'fileManager.file': '文件',
  ...
  'en-US': {
    ...
    'contact.pasteImageHint':
      'Paste screenshots directly into this field. Up to 3 images; large images are compressed when needed.',
    'contact.pastedImages': 'Pasted images',
    'contact.removeImage': 'Remove image',
    'contact.imageCountError': 'You can paste up to 3 images',
    'contact.imageTotalError': 'Images must not exceed 2MB in total',
    ...
    'fileManager.fileTooLarge': '{name} exceeds 50 MB and was not added',
    ...
    'fileManager.dropzoneHint':
      'Any file type is supported, up to 50 MB each. Files upload in sequence to limit memory usage.',
